...
export async function extractSections(
    ...
    if (label_page_numbers["methods"].length === 0) {
        for (const alias of methodAliases) {
            if (
                label_page_numbers[alias] &&
                label_page_numbers[alias].length > 0
            ) {
    ...
    if (skippedLabels.length > 0) {
        elizaLogger.info(`Skipped sections: ${skippedLabels.join(", ")}`);
    } else {
        elizaLogger.info(`All sections were extracted.`, label_page_ranges);
    }
...
export async function getGeneratedBasicInfoText(
    ...
    try {
        ...
        elizaLogger.error("Generated basic info text exception", e);
        return "";
    }
}
...
export async function getGeneratedCitations(
    ...
    try {
        ...
        elizaLogger.info(
            `Generated citations from Claude: ${generated_citations}`
        );
        return generated_citations;
    } catch (e) {
        elizaLogger.error("Generated citations exception", e);
        return "";
    }
}
...
export async function getGoGeneratedSubgraphText(
    ...
    try {
        ...
        try {
            generated_subgraph = JSON.parse(
                generated_subgraph_text
            ) as JSONValue;
        } catch {
            generated_subgraph = {};
        }
        ...
        const updated_subgraph = await updateGoTerms(
            generated_subgraph,
            client
        );
        generated_subgraph_text = JSON.stringify(updated_subgraph);
        elizaLogger.info(
            `Generated subgraph using GO API: ${generated_subgraph_text}`
        );
        return generated_subgraph_text;
    } catch (e) {
        elizaLogger.error("Generated subgraph exception", e);
        return "{}";
    }
}
...
export async function getDoidGeneratedSubgraphText(
    ...
    try {
        ...
        const updated_subgraph = await updateDoidTerms(
            generated_subgraph,
            client
        );
        const finalText = JSON.stringify(updated_subgraph);
        elizaLogger.info(`Generated subgraph using DOID API: ${finalText}`);
        return finalText;
    } catch (e) {
        elizaLogger.error("Generated subgraph exception", e);
        return "[]";
...
export async function getChebiGeneratedSubgraphText(
    ...
    try {
        ...
        const updated_subgraph = await updateChebiTerms(
            generated_subgraph,
            client
        );
        const finalText = JSON.stringify(updated_subgraph);
        elizaLogger.info(`Generated subgraph using CHEBI API: ${finalText}`);
        return finalText;
    } catch (e) {
        elizaLogger.error("Generated subgraph exception", e);
        return "[]";
...
export async function getAtcGeneratedSubgraphText(
    ...
    try {
        ...
        const updated_subgraph = await updateAtcTerms(
            generated_subgraph,
            client
        );
        const finalText = JSON.stringify(updated_subgraph);
        elizaLogger.info(`Generated subgraph using ATC API: ${finalText}`);
        return finalText;
    } catch (e) {
        elizaLogger.error("Generated subgraph exception", e);
        return "[]";
...
export async function get_subgraph_citations(
    ...
    try {
        ...
        elizaLogger.info(`Fixed citations: ${fixed_citations}`);
...
export async function get_subgraph_basic_info(
    ...
    elizaLogger.info(
        `Generated SPAR graph from Claude: ${generated_graph_text}`
    );
...
export async function get_subgraph_go(
    ...
    try {
        ...
        const prompt_go_ontology_ = get_prompt_go_ontology(
            generated_go_subgraph
        );
        const generated_graph_text = await generateResponse(
            client,
        ...
        elizaLogger.info(
            `Generated GO subgraph from Claude: ${generated_graph_text}`
        );
        ...
        elizaLogger.error("Error generating GO subgraph", e);
        return [];
    }
}
...
export function get_subgraph_doid(generated_doid_subgraph: string): JSONValue {
    try {
        ...
        elizaLogger.error("Error generating DOID subgraph", e);
        return [];
    }
}
...
export function get_subgraph_chebi(
    ...
    try {
        ...
        elizaLogger.error("Error generating CHEBI subgraph", e);
        return [];
    }
}
...
export function get_subgraph_atc(generated_atc_subgraph: string): JSONValue {
    try {
        ...
        elizaLogger.error("Error generating ATC subgraph", e);
        return [];
    }
}
...
export async function create_graph(
    ...
    try {
        ...
        elizaLogger.error("Generating graph exception", e);
    }
    ...
    try {
        const subgraphCites = await get_subgraph_citations(
            client,
            citations_text
        );
        generated_graph["cito:cites"] = subgraphCites;
    } catch (e) {
        elizaLogger.error("Error generating citations", e);
    }
...
export async function get_suggested_questions(
    ...
    try {
        ...
        elizaLogger.info(
            `Generated suggested questions from Claude: ${questions}`
        );
        return questions;
    } catch (e) {
        elizaLogger.error("Error generating questions", e);
        return [];
    }
}
